...
if(isset($_POST['add_to_cart'])) {
    ...
    if(mysqli_num_rows($select_cart)>0) {
        ...
        $insert_products = mysqli_query($conn,"insert into `cart`(cart_id, name, price, image, quantity, type) values ('$product_id','$product_name','$product_price','$product_image','$product_quantity','$product_type')");
            ...
            <div class="container">
                ...
                <section class="products">
                    ...
                    <div class="product_container">
                        <?php
                        $search_query = isset($_POST['search_query']) ? $_POST['search_query'] : ''; // Add this line
                        $select_products = mysqli_query($conn,"SELECT * FROM products WHERE name LIKE '%$search_query%' ORDER BY $order_by"); // Update this line
                            ...
                            while($fetch_product = mysqli_fetch_assoc($select_products)) {
                                ...
                                <form method="post" action="">
                                    <div class="edit_form">
                                        ...
                                        <div class="content">
                                            <h3 id="displayname"><?php echo $fetch_product['name']?></h3>
                                            <h4 style="color: #6c757d;"><?php echo $fetch_product['type']?></h4>
                                            ...
                                            <input id="btn-addcart" type="submit" class="submit_btn cart_btn" value="Add to Cart" name="add_to_cart">
                                        </div>
                                    </div>
                                </form>
                            <?php
